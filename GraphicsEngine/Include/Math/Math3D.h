...
public:
	...
	static void register_lua(lua_State* L)
	{
		...
		getGlobalNamespace(L) //global namespace to lua
			.beginNamespace("Math") //our defined namespace (w.e we want to call it)
			.beginClass<Vector2f>("Vector2f") //define class object
...
public:
	...
	//	getGlobalNamespace(L) //global namespace to lua
	//		.beginNamespace("Math") //our defined namespace (w.e we want to call it)
	//		.beginClass<Vector3f>("Vector3f") //define class object
	//		.addConstructor<void(*) ()>()
	//		.addFunction()
	//		.endClass() //end class
	//		.endNamespace(); //end namespace
